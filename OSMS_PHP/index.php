...
<body>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      ...
      <p>
        OSMS Services is Nepal leading chain of multi-brand Electronics and Electrical service
        workshops offering
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Rahul Rai</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Sonam Sherpa</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Sumit Thapa</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Jhon Karki</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        <br><br>
        <strong>Pokhara Branch:</strong> <br>
        OSMS Pvt Ltd, <br>
        Shiva Nagar, Main Chowk <br>
        Pokhara - 804002 <br>
        Phone: +00000000 <br>
        <a href="#" target="_blank">www.osms.com</a> <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Sambid &copy; 2018.
          </small>
